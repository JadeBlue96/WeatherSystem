...
public class XmlPropertyValidator extends com.isoft.base.validation.Validator implements IValidator{
    private final static Logger logger = Logger.getLogger(PropLogger.class.getName());
    private List<String> errorMessages = new ArrayList<String>();
    
    public static final String XML_FILE = "src/com/isoft/base/resources/xml_configs/wdata.xml";
    public static final String SCHEMA_FILE = "src/com/isoft/base/resources/xml_configs/wdata.xsd";
