...
import com.isoft.base.validation.RegexValidator;
import com.isoft.base.validation.UrlValidator;
import com.isoft.base.weather.WType;
...
public class XmlPropertyParser extends CityConfig {
    ...
    public static List<CityConfig> readXMLObjects() {
        ...
        cities = prop_parser.readConfig("src/com/isoft/base/resources/xml_configs/wdata.xml");
        return cities;
    }
