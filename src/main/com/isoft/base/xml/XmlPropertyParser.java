package main.com.isoft.base.xml;
...
import main.com.isoft.base.validation.RegexValidator;
import main.com.isoft.base.validation.UrlValidator;
...
public class XmlPropertyParser extends CityConfig {
    ...
    public static List<CityConfig> readXMLObjects() {
        ...
        cities = prop_parser.readConfig("src/main/com/isoft/base/resources/xml_configs/wdata.xml");
        return cities;
    }
