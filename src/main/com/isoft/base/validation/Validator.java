...
public abstract class Validator {
    ...
    public static List<CityConfig> getValidCitiesByType(boolean isXMLValidationType)
    {
        ...
        try 
        {
            file_validator = Class.forName("main.com.isoft.base.validation.PropFileValidator");
            final Class<?> obj_validator = Class.forName("main.com.isoft.base.validation.PropObjectValidator");
            final Class<?> xml_validator = Class.forName("main.com.isoft.base.validation.XmlPropertyValidator");
        ...
        if(!isXMLValidationType)
        {
            ...
            if(isValidXML)
            {
                cities = main.com.isoft.base.xml.XmlPropertyParser.readXMLObjects();
                if(cities != null)
                {
                    validator.printValidCities(cities);
                }
